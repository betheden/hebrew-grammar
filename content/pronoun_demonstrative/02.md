...
A demonstrative pronoun is a pronoun that refers to a noun or noun phrase that is presumed familiar to the reader or listener. For example if it has been mentioned earlier in the sentence. It can also function as a demonstrative adjective, in which case it commonly follows the noun, even if in English it always precedes the noun.

## Form
In English there are four common demonstrative pronouns that distinguish between singular and plural, as well as near and distant: this, these, that, those. In Hebrew the same distinctions are made, and on top of that there are masculine and feminine forms for each of those (with the exception of the plural, near demonstratives which has a common form).
