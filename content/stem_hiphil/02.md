...
In Biblical Hebrew, some verbs are found only in the Hiphil stem (and/or its stem derivative formations).  In these cases, the Hiphil usually expresses simple action with a causative nuance.  A good example is the Hebrew verb . A dictionary or lexicon will indicate all the stem formations in which a particular is found as well as the appropriate meaning(s).
