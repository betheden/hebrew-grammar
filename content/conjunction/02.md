# conjunction Article
Biblical Hebrew contains only one primary conjunction (the prefix וְ), but a whole family of other words also function as conjunctions.  In Biblical Hebrew, particles are often combined with each other to form compound conjunctions.  Compound conjunctions should not be considered merely as the sum of the components, but rather as a single grammatical entity with its own range of meanings which may or may not be different than the individual component words.  
