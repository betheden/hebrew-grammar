# conjunction Article
Biblical Hebrew contains only one main conjunction (the prefix וְ), but a whole family of other words can also function as conjunctions. Hebrew sentences often start with a ו (usually with shewa, but can take any vowel or appear as shureq). Usually this does not need to be translated.  
...
### Function
Hebrew sentences often start with a ו (usually with shewa, but can take any vowel or appear as shureq). Usually this does not need to be translated.  Unlike the other conjunctions, the ו cannot stand alone as an independent word, but must be connected to another word as a prefix.
...
Like the word כִּי, the word אִם in Biblical Hebrew is also quite flexible in its meaning. If in doubt, it is recommended to always consult a dictionary or lexicon for the exact meaning of the word in any specific instance.
...
<tr class="row-odd"><td>**also**_I in-the-dream</td>
</tr>
