...
It can be extremely difficult sometimes to distinguish between a causal conjunction that expresses purpose and one that expresses result.  When כִּי functions as a causal conjunction, it is often translated into English simply as "for", which can express either purpose or result. 
