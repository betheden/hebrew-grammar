...
In Biblical Hebrew the perfect [verb](https://git.door43.org/Door43/en-uhg/src/master/content/verb/02.md) is generally used to describe actions that have occurred in the past or actions that are completed (even in present and future time). However, the perfect form is also used to describe a variety of other kinds of actions. Thus, a perfect verb has the potential to be translated with the past tense, the present tense, or even the future tense. The context must determine the proper meaning for each instance of a perfect verb.

When the [conjunction](https://git.door43.org/Door43/en-uhg/src/master/content/conjunction/02.md#) *waw* (וְ "and") is added to the perfect form as a prefix, this can indicate either a [perfect copulative](https://git.door43.org/Door43/en-uhg/src/master/content/verb_perfect/02.md#perfect-copulative-perfect-with-a-conjunction) or a [sequential perfect](https://git.door43.org/Door43/en-uhg/src/master/content/verb_sequential_perfect/02.md) form. The meaning of the verb is different in either case, and the context must be carefully considered to determine if it is a perfect copulative or sequential perfect.  
...
This form adds the [conjunction](https://git.door43.org/Door43/en-uhg/src/master/content/conjunction/02.md#) *waw* (וְ "and") to a normal perfect verb and can express any of the above meanings. This form appears identical to the [sequential perfect](https://git.door43.org/Door43/en-uhg/src/master/content/verb_sequential_perfect/02.md).
