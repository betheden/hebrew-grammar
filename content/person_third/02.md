...
<tr class="row-even" align="center"><td>Pronomial suffix, Third person masculine plural</td><td>לָהֶם / -הֶם / - ָם</td><td>**</td><td>(to) them</td>
</tr>
<tr class="row-odd" align="center"><td>Pronomial suffix, Third person feminine plural</td><td>לָהֶן / -הֶן / - ָן</td><td>**</td><td>(to) them</td>
</tr>
</tbody>
</table>

Hebrew distinguishes between [masculine](https://git.door43.org/Door43/en-uhg/src/master/content/gender_masculine/02.md) and [feminine](https://git.door43.org/Door43/en-uhg/src/master/content/gender_feminine/02.md) in both [singular](https://git.door43.org/Door43/en-uhg/src/master/content/number_singular/02.md) and [plural](https://git.door43.org/Door43/en-uhg/src/master/content/number_plural/02.md). It does not have a neutral "it," but since all nouns have a msculine or feminine gender, it does not need a neutral form.
