...
The word כִּי is most often used either as a causal conjunction (usually translated, "for") or a conditional conjunction (usually translated, "if").  As a general rule, כִּי is usually conditional when it occurs at the beginning of a sentence, and causal when it occurs in the middle (or toward the end) of a sentence.

### Causal

It can be extremely difficult sometimes to distinguish between a causal conjunction that expresses purpose and one that expresses result.  When כִּי functions as a causal conjunction, it is usually translated into English simply as "for", which can express either purpose or result. 
