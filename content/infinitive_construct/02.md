...
When the infinitive absolute takes a [pronominal suffix](https://git.door43.org/Door43/en-uhg/src/master/content/suffix_pronominal/02.md), that suffix can be either the subject or the object of the infinitive itself (not the main verb) as determined by the context. 
