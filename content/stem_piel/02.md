...
Resultative action means that the primary focus of the verb is on the result of the verbal action.  A good example is the verb ???.  In the Qal stem, the verb ??? means "to send" or "to stretch".  In the Piel stem, the verb ??? means "to send away".  
...
Causative action means that the subject of the verb is causing the object of the verb either to perform the verbal action (dynamic verbs) or to be in a certain state (stative verbs).  The Piel stem often serves this function with stative verbs.  A good example in the verb ???.  In the Qal stem, the verb ??? expresses the simple action of "to be full".  But in the Piel stem, the verb ??? means "to fill" (meaning, *to cause something to be full*).
